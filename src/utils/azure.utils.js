...
var uploadToBlob = function (file, key, contentType) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                blobService = Azure.createBlobService("".concat(process.env.accountName), "".concat(process.env.accountKey));
                return [4 /*yield*/, new Promise(function (resolve, reject) {
                        blobService.createBlockBlobFromStream(process.env.containerName, key, Readable.from(file), contentType, {}, function (error) {
                            if (error) {
                                reject(error);
                            }
                            else {
