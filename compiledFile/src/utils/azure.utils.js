...
var uploadToBlob = function (file, key, contentType, config) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                blobService_1 = Azure.createBlobService(config.account, config.secret);
                return [4 /*yield*/, new Promise(function (resolve, reject) {
                        blobService_1.createBlockBlobFromStream(config.location, key, Readable.from(file), contentType, {}, function (error) {
                            if (error) {
                                reject(error);
                            }
                            else {
